class EmploymentHistoryService {
  ...
  all () {
    ...
    let ipc_media = new Employer('IPC Media', 'http://www.ipcmedia.com/')

    let ipc_senior = new Role('Senior Developer', new Date('2013-09-01'), new Date('2013-12-01'))
    ...
    let ipc = new Role('Developer', new Date('2012-05-01'), new Date('2013-09-01'))
    ...
    let chroma = new Role('Developer', new Date('2011-04-01'), new Date('2012-05-01'))
    ...
    let zeevo = new Role('Developer', new Date('2010-06-01'), new Date('2011-04-01'))
    ...
    return [bbc, rightster, ipc_senior, ipc, chroma, zeevo]
  }

}

angular.module('resumeApp').factory('employmentHistoryService', () => new EmploymentHistoryService())
